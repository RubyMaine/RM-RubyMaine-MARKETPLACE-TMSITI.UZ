...
class Cart_model extends CI_Model
{
    ...
    public function calculate_cart_total($cart_items, $currency_code = null, $set_session = true)
    {
        ...
        $cart_total->coupon_discount_products = $array_discount['product_ids'];
        if (!empty($cart_total->coupon_discount_products)) {
            $cart_total->coupon_discount_products = trim($cart_total->coupon_discount_products, ',');
        }
    ...
    public function calculate_coupon_discount($cart_items)
    {
        ...
        return ['discount_rate' => $discount_rate, 'total_discount' => $total_discount, 'seller_id' => $seller_id, 'product_ids' => $product_ids];
    }
